	...
	.vp-edit__address
		.vp-drawer__row.vp-field__group
			input.vp-field.vp-field--half(
				v-model="updateInfo.billing_first_name"
				placeholder="First Name"
			)
			input.vp-field.vp-field--half(
				v-model="updateInfo.billing_last_name"
				placeholder="Last Name"
			)
		.vp-drawer__row
			.vp-field
				input(
					v-model="updateInfo.billing_address1"
					placeholder="Address Line 1"
				)
		.vp-drawer__row
			.vp-field
				input(
					v-model="updateInfo.billing_address2"
					placeholder="Address Line 2"
				)
		.vp-drawer__row
			.vp-field
				input(
					v-model="updateInfo.billing_company"
					placeholder="Company"
				)
		.vp-drawer__row
			.vp-field.vp-field--select
				select(
					v-model="updateInfo.billing_country"
				)
					option(
		...
		.vp-drawer__row.vp-field__group
			...
			.vp-field.vp-field--half.vp-field--select
				select(
					v-model="updateInfo.billing_province"
				)
					option(
		...
		.vp-drawer__row.vp-field__group
			.vp-field.vp-field--half
				input(
					v-model="updateInfo.billing_zip"
					placeholder="Zip Code"
					pattern="[0-9]{5}"
				)
			.vp-field.vp-field--half
				input(
					v-model="updateInfo.billing_phone"
